...
import { ArrowLeft, FileText, AlertCircle, CheckCircle, Info, Download, Loader2 } from "lucide-react";
  ...
  const handleDownload = async () => {
    ...
    try {
      await downloadStaticPdfWithTopLeftLogo(
        "/asta-forms/NRLA-AST-room-only-completion-instructions-2025.pdf",
        "NRLA-AST-room-only-completion-instructions-2025"
      );
    } finally {
